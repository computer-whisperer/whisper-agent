...
//! Mirrors the shape of `whisper-agent-mcp-fetch` so the scheduler can talk to
...
use crate::tools::{self, SearchConfig};
...
fn initialize(id: Value, params: Option<Value>) -> JsonRpcResponse {
    ...
    let result = InitializeResult {
        ...
        instructions: Some("Web search via the Brave Search API.".into()),
    };
