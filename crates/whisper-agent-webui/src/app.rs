...
use whisper_agent_protocol::{
    ...
    HostEnvProviderInfo, HostEnvSpec, ImageMime, ImageSource, Message, ModelSummary, NamedHostEnv,
    PodAllow, PodConfig, PodLimits, PodSummary, ResourceSnapshot, Role, ServerToClient,
