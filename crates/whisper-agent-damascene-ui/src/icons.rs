...
//!
//! Damascene's built-in [`damascene_core::IconName`] registry is small (17
...
//! redistribute). When a future damascene upstream registers any of these
...
/// knowledge-buckets modal. Lucide doesn't ship `database` in damascene's
